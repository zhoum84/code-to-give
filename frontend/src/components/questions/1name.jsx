...
const Name = () => {
    ...
    const content = (
        <div className="flex-col">
                <div className="flex-col">
                    <h1 className='question' htmlFor="billFirstName">What is your name?</h1>
                    <label className='parameter' htmlFor="billLastName">First Name</label>
                    <input
                        type="text"
                        id="billFirstName"
                        name="billFirstName"
                ...
                <div className="flex-col">
                    <label className='parameter' htmlFor="billLastName">Last Name</label>
                    <input
                        type="text"
                        className='field-input'
                        id="billLastName"
